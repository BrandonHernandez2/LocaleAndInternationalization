...
public class Main {
    ...
    private static void printFormattedDate(Locale locale, LocalDate date) {
        ...
        System.out.println(locale.getDisplayLanguage() + " is the language and the Country is " + locale.getDisplayCountry());
        ...
        DateTimeFormatter formatter1 = DateTimeFormatter.ofPattern("MM d yy");
